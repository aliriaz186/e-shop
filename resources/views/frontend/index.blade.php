...
@section('content')
 ...
 @if($num_todays_deal > 0)
                <div class="col-lg-2 d-none d-lg-block" style="margin-left: 183px; height: 139px;">
                    <div class="flash-deal-box bg-white h-100">
                        <div class="title text-center p-2 gry-bg" style="margin-left: -199px;">
                            ...
                            @foreach (filter_products(\App\Product::where('published', 1)->where('todays_deal', '1'))->get() as $key => $product)
                                @if ($product != null)
                                    <a href="{{ route('product', $product->slug) }}" class="d-block flash-deal-item">
                                        <div class="row no-gutters align-items-center" style="margin-top: -33px;">
                                            <div class="col" ">
                                                <div class="img">
    ...
    <div class="mb-4" style="margin-top: 132px;">
        <div class="container">
